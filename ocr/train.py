...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread(tcfg.trainImgFpath)            # read in training numbers image
    ...
    np.savetxt(tcfg.resultClass, npaClassifications)           # write flattened images to file
    np.savetxt(tcfg.resultFlatten, npaFlattenedImages)          #
